...
\affil[a]{Institute of Fluid-Flow Machinery, Polish Academy of Sciences, Fiszera 14St, 
Gdansk, Poland}
...
displacement recordings, methods based on natural frequencies, measurements of 
velocities of bulk waves (longitudinal and shear).
