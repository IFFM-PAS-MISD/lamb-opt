...
%DIF DEL SPIE2020.tex      Wed Feb 19 08:17:15 2020
%DIF ADD SPIE2020_R1.tex   Wed Feb 19 08:26:21 2020
...
%DIF PREAMBLE EXTENSION ADDED BY USER
...
\providecommand{\DIFdeltex}[1]{{\protect\color{mygrey}\scriptsize{#1}}}                       %DIF PREAMBLE
%DIF PREAMBLE
...
%DIF END PREAMBLE EXTENSION ADDED BY USER %DIF PREAMBLE
...
in Refs.~\citenum{Alred03}\DIFdelbegin \DIFdel{and }%DIFDELCMD < \citenum{Perelman97}%%%
\DIFdelend , for example.  Many aspects of 
technical writing are addressed in the {\em AIP Style Manual}, published by the 
American Institute of Physics  \DIFaddbegin \citenum{Lees-Miller-LaTeX-course-1}\DIFaddend .  It is available on 
...
Tables are handled identically to figures, except that their captions appear above the table. 
   ...
   \DIFdelbeginFL %DIFDELCMD < \includegraphics[height=5cm]{mcr3b.eps}
%DIFDELCMD <    %%%
\DIFdelendFL %DIF > \includegraphics[height=5cm]{mcr3b.eps}
   \DIFaddbeginFL \includegraphics{E:/work/projects/opus15/lamb-opt/reports/figures/SASE/SASE20_plain_weave_out/SASE20_plain_weave_angle_0_param_dispersion_curves_color.png}
   \DIFaddendFL \end{tabular}
   \end{center}
   \caption[example] 
%>>>> use \label inside caption to get Fig. number with \ref{}
   { \DIFdelbeginFL %DIFDELCMD < \label{fig:example} 
%DIFDELCMD < %%%
...
\begin{figure} [ht]
	\begin{center}
		\begin{tabular}{c} %% tabular useful for creating an array of images 
			...
			\includegraphics{E:/work/projects/opus15/lamb-opt/reports/figures/SASE/SASE19_plain_weave_out/SASE19_plain_weave_angle_0_param_dispersion_curves_color.png}
		\end{tabular}
	\end{center}
	\caption[example] 
	%>>>> use \label inside caption to get Fig. number with \ref{}
