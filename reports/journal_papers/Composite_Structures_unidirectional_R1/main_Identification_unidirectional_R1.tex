...
Hence, if the experimental to numerical signal comparison is performed, errors increases with the signal duration.
Also, the performance of algorithms such as phased arrays~\cite{Yu2016,Adlakha2020}, delay-and-sum~\cite{Michaels2008b} and Lamb wave focusing~\cite{Kudela2018c} which rely on the guided wave velocities is deteriorated.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The investigation begin with experimental measurements by the SLDV on a composite specimen.
...
Higher-order theories of shells or even high-order 3D solid elements can be useful when high frequency, high-order Rayleigh-Lamb wave modes are considered.
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Potential for further implementations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Although laminated fibre-reinforced composites are analysed here, the methodology can be adapted and expanded for other materials within higher frequency range.
In particular it can be adapted for high-contrast multi-layered structures, e.g. laminated glass and photovoltaic panels for which dispersion curves can be calculated by various methods available in the literature~\cite{Kaplunov2017}.
Another example is concerned with layered coatings and interfacial layers not supporting fundamental modes of Lamb waves~\cite{Prikazchikova2020}.
