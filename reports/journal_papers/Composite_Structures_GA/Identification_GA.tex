...
\begin{document}
	...
	The paper by Beluch and Burczyński~\cite{Beluch2014} deals with the two-scale approach to the identification of material constants in composite materials. Structures made of unidirectionally fibre-reinforced composites are examined. However, for optimisation of elastic constants, static displacements and eigenfrequencies are used, not Lamb wave data. Additionally, plane strain state was assumed in the model.
   ...
   The general wave equation has a form of eigenvalue problem:
	...
	\end{itemize}
In the later case, the solution consist of recasting Eq.~(\ref{eq:eig_dispersion}) to a first-order eigensystem by doubling its algebraic size.  The obtained wavenumbers are then of a complex character. This provides information about both the wave dispersion (real part of the wavenumbers) and the attenuation of the waves (imaginary part of the wave numbers).  However, due to the fact that the priority is the computation time and that the information about the wave attenuation is not necessary, it is preferable to solve the standard eigenvalue problem $\omega (k)$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The influence of fibres density on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:rhof}. Similar changes of dispersion curves as in case of matrix density can be noticed.
...
The influence of matrix Young's modulus on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:em}. Large changes of dispersion curves of antisymmetric modes can be observed. Contrary, changes of dispersion curves of symmetric modes at frequencies up to about 300~kHz are small.
...
The influence of fibres Young's modulus on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:ef}. In this case small to moderate changes of dispersion curves depending on guided wave mode can be observed. 
...
The influence of matrix Poisson's ratio on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:nim}. Small changes of dispersion curves can be observed.
...
The influence of fibres Poisson's ratio on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:nif}. It can be noticed that this parameter influences least the dispersion curves of guided waves.
...
The influence of volume fraction of reinforcing fibres on dispersion curves depending on the propagation angle $\beta$ is shown in Fig.~\ref{fig:vol}. It is the most essential parameter among analysed properties because it has the greatest influence on dispersion curves of guided waves.
...
\clearpage
It can be seen that increase of densities causes increase of wavenumber values, whereas increase of Young's modulus and volume fraction of reinforcing fibres causes decrease of wavenumber values. The changes of Poisson's ratio causes mixed influence on dispersion curves in this regard depending on propagation mode.
...
The total weight of a specimen was 8550 g, hence, based on the volume of the specimen the density is about~1522.4~kg/m\textsuperscript{3}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\item direct - determination of C-tensor components.
...
\begin{figure} [h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\caption{}
		\label{fig:dispersion0deg_initial}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
   ...
   \end{subfigure}
    ...
    \end{subfigure}
	\caption{Dispersion curves for optimised elastic constants at angles $\beta$: (a) 0$^{\circ}$, (b) 15$^{\circ}$, (c) 30$^{\circ}$, (d) 45$^{\circ}$, (e) 75$^{\circ}$, (f) 90$^{\circ}$; yellow curves: SASE model; image: experiment. }
	\label{fig:optimized}
\end{figure}
