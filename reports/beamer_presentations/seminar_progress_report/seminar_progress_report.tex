...
\includeonlyframes{frameone,frametwo,framethree,framefour,framefive}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Packages
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% SLIDES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frameone]{Table of contents \label{frameone}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frametwo]{Determination of mechanical properties of materials}
  \begin{itemize}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=framethree]{Pulsed Ultrasonic Polar Scans}
\begin{figure}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=framefour]{Dispersion curves (1)}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=framefive]{Dispersion curves (2)}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=framefive]{Dispersion curves (3)}
Signals in time and frequency domain
Wave dispersion consequence
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=framefive]{Idea of the project}
	\begin{figure}
		\only<1>{
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t]{SASE dispersion curves: Poisson's ratio influence}
%\vspace{6pt}
\def\myindenta{0.12\textwidth} % define myindenta variable  for correcting caption placement
\begin{columns}[T]
	\column{0.5\textwidth}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t]{SASE dispersion curves: volume fraction influence}
%\vspace{6pt}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t]{Comparison of numerical and experimental dispersion curves}
%\vspace{6pt}
\def\myindenta{0.05\textwidth} % define myindenta variable  for correcting caption placement
\newcommand{\modelname}{SASE1}
\begin{figure}
	\only<1>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_0_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{0}$^{\circ}$}
	}
	\only<2>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_15_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{15}$^{\circ}$ }
	}
	\only<3>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_30_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{30}$^{\circ}$ }
	}
	\only<4>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_45_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{45}$^{\circ}$ }
	}
	\only<5>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_60_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{60}$^{\circ}$ }
	}
	\only<6>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_75_num_exp_dispersion.png}
		\caption{\hspace{\myindenta}Comparison of numerical and experimental dispersion curves at angle \textbf{75}$^{\circ}$ }
	}
	\only<7>{
		\includegraphics[width=0.86\textwidth]{SASE/\modelname_out/\modelname_25_angle_90_num_exp_dispersion.png}
