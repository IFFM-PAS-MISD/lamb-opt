...
\graphicspath{{../../figures/}{../../figures/beamer_common/}{../../journal_papers/Composite_Structures_GA/figs/}}
...
\begin{figure} [h!]
	...
	\centering
	\only<1>{
		\includegraphics[width=0.9\textwidth]{genetic_algorithm/\modelname_out/\modelname_angle_60_dispersion_curves_exp_large.png}
	}
	\only<2>{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t,label=frame22]{Objective function (1)}
\only<1-2>{
	\begin{equation*}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t,label=frame23]{Objective function (2)}
\begin{columns}[T]
	\column{0.5\textwidth}
	\begin{figure} [h!]
		\newcommand{\modelname}{ga_plain_weave_known_mass}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t,label=frame26]{Numerical and experimental dispersion curves in \alert{indirect} method}
%\vspace{6pt}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t,label=frame28]{Numerical and experimental dispersion curves in \alert{direct} method}
%\vspace{6pt}
\def\myindenta{0.05\textwidth} % define myindenta variable  for correcting caption placement
