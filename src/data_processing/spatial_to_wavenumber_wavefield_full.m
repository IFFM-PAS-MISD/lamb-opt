function [KXKYF,kx_vec,ky_vec,f_vec] = spatial_to_wavenumber_wavefield_full(Data,Length,Width,time)
...
%    kx_vec - vector of wavenumbers in x direction, double, dimensions [1,512], Units: rad/m 
%    ky_vec - vector of wavenumbers in y direction, double, dimensions [1,512], Units: rad/m 
%    f_vec - vector of frequency components, double, dimensions [1,512], Units: Hz
% 
% Example: 
