...
modelfolder = 'SASE';
modelname = {'SASE1','SASE2'}; % cell list of models for processing
...
exp_filename = {'polar_interim_289x289p_HANN100_x30_10Vpp_200Hz_KXKYF_',...
                'polar_interim_289x289p_HANN100_x30_10Vpp_200Hz_KXKYF_'}; 
