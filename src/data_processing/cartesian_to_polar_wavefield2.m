function [Data_polar,number_of_points,radius] = cartesian_to_polar_wavefield2(Data,Lx,Ly,beta)
% cartesian_to_polar_wavefield2   transform wavefield to polar coordinates 
...
% 
% Syntax: [Data_polar,number_of_points,radius] = cartesian_to_polar_wavefield2(Data,Lx,Ly,beta) 
% 
% Inputs: 
...
% 
% Example: 
%    [Data_polar,number_of_points,radius] = cartesian_to_polar_wavefield2(Data,Lx,Ly,beta) 
%    [Data_polar,number_of_points,radius] = cartesian_to_polar_wavefield2(Data,Lx,Ly,[0:15:90])  
% 
...
Data_polar=zeros(number_of_angles,number_of_points,number_of_time_steps);
 %%
[XI,YI] = meshgrid(linspace(lymin,lymax,nPointsy),linspace(lxmin,lxmax,nPointsx)); % due to columnwise plotting nPointsx is for x coordinates and nPointsy is for y coordinates
X=reshape(XI,[],1);
Y=reshape(YI,[],1);
 %% 
...
% ================ [cartesian_to_polar_wavefield2.m] ================  
