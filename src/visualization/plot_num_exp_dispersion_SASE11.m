% plot numerical dispersion curves on top of experimental data (fabric composite)
...
filename = 'polar_interim_289x289p_HANN100_x30_10Vpp_200Hz_KXKYF'; 
...
%test_case = 23; % best objective function score for all modes
%test_case = 23; % best objective function score for A0 mode only
