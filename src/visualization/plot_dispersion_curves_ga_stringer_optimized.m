...
modelname = 'ga_stringer_C_tensor_known_mass';
modelname2= 'ga_stringer_optimized';
radians = false;
test_case=10; % numerical data
% create output path
...
ht = 2.2/1000; % [m] laminate total thickness; unidirectional
