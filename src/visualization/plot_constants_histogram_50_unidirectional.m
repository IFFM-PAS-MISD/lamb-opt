...
modelname = 'ga_unidirectional_known_mass';
...
for test_case=range
    ...
    load(output_name); % 'rhom','rho_f','e11_m','e11_f','ni12_m','ni12_f','vol_0','C11','C12','C13','C22','C23','C33','C44','C55','C66','rho','ObjVal'
...
hist(C11_(range),8);
 ...
 paper_path=[projectroot,'reports',filesep,'conference_papers',filesep,'EWSHM2020MR',filesep];
 ...
 writetable(T2,[paper_path,'results_indirect_50.csv'],'WriteRowNames',true);
  ...
  % second table
 Constants3 = {'$C_{11}$';'$C_{12}$';'$C_{13}$';'$C_{22}$';'$C_{23}$';'$C_{33}$';'$C_{44}$';'$C_{55}$';'$C_{66}$';'$F$'};
 T3 = table(Cdbest,Cdmean,Cdstd,'RowNames',Constants3);
 writetable(T3,[paper_path,'results_direct_50.csv'],'WriteRowNames',true);
