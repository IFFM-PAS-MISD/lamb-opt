function hpol = newPolar(theta,rho,maxrho,line_style)
...
% draw radial circles
    ...
    for i=(rmin+rinc):rinc:rmax
        hhh = plot(xunit*i,yunit*i,ls,'color',tc,'linewidth',lw1,...
                   'handlevisibility','off');
...
% plot spokes
    ...
    cs = [-cst; cst];
    sn = [-snt; snt];
    plot(rmax*cs,rmax*sn,ls,'color',tc,'linewidth',lw1,...
         'handlevisibility','off')
...
if strcmp(line_style,'auto')
    q = plot(xx,yy,'linewidth',lw2);
else
    q = plot(xx,yy,line_style,'linewidth',lw2);
end
if nargout > 0
    hpol = q;
end
