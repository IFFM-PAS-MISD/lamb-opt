...
clear all; close all;
%/home/pkudela/work/projects/opus15/lamb-opt/src/data_processing/spatial_to_wavenumber_wavefield_selected_script_GFRP_Rohan.m
%/home/pkudela/work/projects/opus15/lamb-opt/src/data_processing/cartesian_to_polar_wavenumber_wavefield_script.m
...
% maybe it should be 3 modes due to shear mode mixed with S0???
%% Load parameters which are used in experiment
% create path to the experimental processed data folder
data_path=fullfile( projectroot, 'data','processed','exp', filesep );
input_file = 1;
% filename of parameter data
 filename = {'polar_interim_40f1x401p_chirp500_x10_2Vppx100_KXKYF_param'}; 
 load([data_path,filename{input_file}]); % wavenumber_max fmax beta number_of_wavenumber_points
% load experimental data file
exp_filename = {'polar_interim_401x401p_chirp500_x10_2Vppx100_KXKYF'};
...
ht = 3.34/1000; % [m] laminate total thickness;
...
variation = 0.7; % 20% is too small - change to 50%
...
% postprocessing
%/home/pkudela/work/projects/opus15/lamb-opt/src/visualization/plot_dispersion_curves_ga_GFRP_Rohan_optimized.m
%%
% plot GA convergence
