function [ObjV] = obj_ga_pzt_unidirectional_1(Phen,time,signals,layup,h,wavenumber_min,wavenumber_max,number_of_wavenumber_points,beta,stack_dir,np,nele_layer,number_of_modes_considered,rho,w,D0,Nb,L)
