...
% maybe it should be 3 modes due to shear mode mixed with S0??? Yes, second
% mode is SH0, third is S0
%% Load parameters which are used in experiment
% create path to the experimental processed data folder
data_path=fullfile( projectroot, 'data','processed','exp', filesep );
input_file = 1;
...
ht = 2.086/1000; % [m] laminate total thickness;
...
layup = [45,0,-45,90,-45,0,45,90,90,45,0,-45,90,-45,0,45]-90;
%layup = [45,0,-45,90,90,-45,0,45]-90;
