...
% filename of parameter data
 filename = {'polar_interim_499x499_chp160_x10_4Vpp_UpTo250kHz__KXKYF_param'}; 
 load([data_path,filename{input_file}]); % wavenumber_max fmax beta number_of_wavenumber_points
% load experimental data file
exp_filename = {'polar_interim_499x499_chp160_x10_4Vpp_UpTo250kHz__KXKYF'};
...
ht = 1.5/1000; % [m] laminate total thickness;
