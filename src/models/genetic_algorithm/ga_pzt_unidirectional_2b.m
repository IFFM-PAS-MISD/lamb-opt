...
Q11_0 = 100e9; % it wass 100 before
Q12_0 = 5.7e9;
Q13_0 = 5.7e9;
Q22_0 = 100e9;
Q23_0 = 5.5e9;
...
variation = 0.9; % 20% is too small - change to 50%
    ...
    output_name = [model_output_path,filesep,num2str(test_case),'output'];
     if(overwrite||(~overwrite && ~exist([output_name,'.mat'], 'file')))
       ...
       gen = 0;			% generational counter
        ...
        [ObjV] = obj_ga_pzt_unidirectional_1(Phen,time,signals,layup,h,wavenumber_min,wavenumber_max,number_of_wavenumber_points,beta,stack_dir,np,nele_layer,number_of_modes_considered,rho,w,D0,Nb,L);
       ...
       while gen < MAXGEN
            ...
            if(mod(gen,ROGSTEP)==0) % random offspring generation
                ...
                [ObjVRand] = obj_ga_pzt_unidirectional_1(bs2rv(RandChrom,FieldD),time,signals,layup,h,wavenumber_min,wavenumber_max,number_of_wavenumber_points,beta,stack_dir,np,nele_layer,number_of_modes_considered,rho,w,D0,Nb,L);
        ...
        % Evaluate offspring, call objective function
            %tic;
           [ObjVSel] = obj_ga_pzt_unidirectional_1(bs2rv(SelCh,FieldD),time,signals,layup,h,wavenumber_min,wavenumber_max,number_of_wavenumber_points,beta,stack_dir,np,nele_layer,number_of_modes_considered,rho,w,D0,Nb,L);
