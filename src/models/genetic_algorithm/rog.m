function [Chrom,ObjV] = rog(ROGR,NIND,NVAR,PRECI,ObjV,FieldD,Chrom,ObjfunArg)
...
[ObjVRand] = obj_ga_C_tensor_known_mass_unidirectional(bs2rv(RandChrom,FieldD),ObjfunArg.Data_polar,ObjfunArg.layup,ObjfunArg.h,ObjfunArg.wavenumber_min,ObjfunArg.wavenumber_max,ObjfunArg.number_of_wavenumber_points,ObjfunArg.beta,ObjfunArg.stack_dir,ObjfunArg.np,ObjfunArg.nele_layer,ObjfunArg.fmax,ObjfunArg.number_of_modes_considered,ObjfunArg.rho);
