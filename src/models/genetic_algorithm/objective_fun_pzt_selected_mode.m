function [obj_score,sp1] = objective_fun_pzt_selected_mode(time,signals,L,CG,FREQ,wavenumber,selected_mode,w,D0,Nb)
...
% manual mode tracing
temp=squeeze(FREQ(3,1:26,7));
FREQ(3,1:26,7)=FREQ(4,1:26,7);
FREQ(4,1:26,7)=temp;
%
